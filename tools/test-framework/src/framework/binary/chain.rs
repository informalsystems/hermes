...
pub struct RunBinaryChainFromInterchainSecurityTest<'a, Test> {
    /// Inner test
    pub test: &'a Test,
}

impl<'a, Test> RunBinaryChainFromInterchainSecurityTest<'a, Test>
where
    Test: BinaryChainTest,
{
...
impl<'a, Test, Overrides> InterchainSecurityChainTest
    for RunBinaryChainFromInterchainSecurityTest<'a, Test>
where
    Test: BinaryChainTest,
    Test: HasOverrides<Overrides = Overrides>,
