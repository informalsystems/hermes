...
/*struct DeprecatedIbcForwardTransferTest;

impl NaryChannelTest<3> for DeprecatedIbcForwardTransferTest {
    fn run<Handle: ChainHandle>(
        &self,
        _config: &TestConfig,
        _relayer: RelayerDriver,
...
/*impl HasOverrides for DeprecatedIbcForwardTransferTest {
    type Overrides = IbcForwardTransferTestOverrides;
