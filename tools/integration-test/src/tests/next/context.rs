...
use ibc_relayer_cosmos::cosmos::handler::{CosmosChainHandler, CosmosRelayHandler};
use ibc_test_framework::types::binary::chains::ConnectedChains;

pub fn build_cosmos_relay_context<ChainA, ChainB>(
    chains: &ConnectedChains<ChainA, ChainB>,
) -> CosmosRelayHandler<ChainA, ChainB>
where
    ChainA: ChainHandle,
    ChainB: ChainHandle,
{
    let handler_a = CosmosChainHandler {
    ...
    let handler_b = CosmosChainHandler {
    ...
    let relay_handler = CosmosRelayHandler {
