...
COSMOS_SDK_COMMIT="$(cat crates/proto/src/COSMOS_SDK_COMMIT)"
IBC_GO_COMMIT="$(cat crates/proto/src/IBC_GO_COMMIT)"
...
rm -rf crates/proto/src/prost
mkdir -p crates/proto/src/prost
