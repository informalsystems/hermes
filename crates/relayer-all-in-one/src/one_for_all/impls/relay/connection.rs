    ...
    Relay: OfaRelay,
{
    async fn init_connection(
        &self,
        init_connection_options: &<Relay::SrcChain as OfaChainTypes>::InitConnectionOptions,
    ) -> Result<<Relay::SrcChain as OfaChainTypes>::ConnectionId, Self::Error> {
    ...
    Relay: OfaRelay,
{
    async fn relay_connection_open_try(
        &self,
        src_connection_id: &<Relay::SrcChain as OfaChainTypes>::ConnectionId,
    ) -> Result<<Relay::DstChain as OfaChainTypes>::ConnectionId, Self::Error> {
    ...
    Relay: OfaRelay,
{
    async fn relay_connection_open_ack(
        &self,
        src_connection_id: &<Relay::SrcChain as OfaChainTypes>::ConnectionId,
        dst_connection_id: &<Relay::DstChain as OfaChainTypes>::ConnectionId,
    ) -> Result<(), Self::Error> {
