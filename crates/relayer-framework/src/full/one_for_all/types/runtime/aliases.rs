...
pub type EventResultSender<Chain, Error> = Sender<Chain, EventResult<Chain, Error>>;

pub type EventResultReceiver<Chain, Error> = Receiver<Chain, EventResult<Chain, Error>>;
