...
fn get_name_from_module_event_attributes(
    attributes: &Vec<ibc::core::router::types::event::ModuleEventAttribute>,
) -> String {
...
fn convert_timeout_height(
    timeout_height: ibc::core::channel::types::timeout::TimeoutHeight,
) -> Result<TimeoutHeight, NearError> {
    match timeout_height {
        ibc::core::channel::types::timeout::TimeoutHeight::Never => Ok(TimeoutHeight::Never),
        ibc::core::channel::types::timeout::TimeoutHeight::At(height) => Ok(TimeoutHeight::At(
