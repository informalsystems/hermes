...
use crate::{
    chain::{
        cosmos::CosmosSdkChain, handle::ChainHandle, namada::NamadaChain, runtime::ChainRuntime,
        ChainType,
    },
    config::Config,
...
pub fn spawn_chain_runtime<Handle: ChainHandle>(
    ...
    let handle = match chain_config.r#type {
        ...
        ChainType::Namada => ChainRuntime::<NamadaChain>::spawn::<Handle>(chain_config, rt),
    }
