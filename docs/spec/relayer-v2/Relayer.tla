...
vars == <<chains, outgoingDatagrams, relayerChainHeights>>           
envVars == <<chains>>           
...
LightClientUpdates(srcChainID, dstChainID, relayer) ==
    LET srcChain == chains[srcChainID] IN
    LET dstChain == chains[dstChainID] IN
...
PendingDatagrams(srcChainID, dstChainID) ==
    ...
    LET clientDatagrams == 
        ...
        THEN LightClientUpdates(srcChainID, dstChainID, relayerChainHeights) 
        ELSE {} IN
