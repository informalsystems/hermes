...
<!-- The hypothesis that this document is testing is that it can inform an implementation beneficially, i.e., help better design the abstraction and architecture of an implementation of connection handshake protocol. -->
