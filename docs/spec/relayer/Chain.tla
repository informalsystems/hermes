...
vars == <<chainStore, incomingDatagrams, history, packetLog, appPacketSeq>>
...
UpdateChainStore(chainID, datagrams) == 
    ...
    \* ICS 004: Packet transmission (TODO)
...
\* Last modified Tue Sep 15 16:29:42 CEST 2020 by ilinastoilkovska
