...
- create client:
    ...
    hermes -c config.toml query client state ibc-1 07-tendermint-0
    ```
...
```shell script
hermes -c config.toml tx raw ft-transfer ibc-1 ibc-0 transfer channel-1 9999 1000 -n 1 -d ibc/C1840BD16FCFA8F421DAA0DAAB08B9C323FC7685D0D7951DC37B3F9ECB08A199
