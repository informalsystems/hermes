...
| `oldest_sequence`            | Sequence number of the oldest pending SendPacket event | `u64` ValueRecorder |
| `oldest_timestamp`           | Local timestamp of the oldest pending SendPacket event | `u64` ValueRecorder |
