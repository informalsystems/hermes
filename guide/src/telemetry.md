...
| `clear_send_packet_count`    | Number of SendPacket events processed during ClearPendingPackets | `u64` Counter   |
| `clear_acknowledgment_packet_count` | Number of WriteAcknowledgement events processed during ClearPendingPackets | `u64` Counter   |
...
# HELP clear_send_packet_count Number of SendPacket events processed during ClearPendingPackets
# TYPE clear_send_packet_count counter
clear_send_packet_count{chain="ibc-1",channel="channel-0",counterparty="ibc-0",port="transfer"} 15
