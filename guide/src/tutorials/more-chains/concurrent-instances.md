...
```shell
{{#template ../../templates/commands/hermes/query/packet/pending.md CHAIN_ID=ibc-1 PORT_ID=transfer CHANNEL_ID=channel-2}}
```
...
```shell
{{#template ../../templates/commands/hermes/clear/packets.md OPTIONS=--config $HOME/hermes_second_instance.toml CHAIN_ID=ibc-1 PORT_ID=transfer CHANNEL_ID=channel-2}}
```
...
- On `ibc-0`:
    ```shell
    {{#template ../../templates/commands/hermes/query/packet/pending.md CHAIN_ID=ibc-0 PORT_ID=transfer CHANNEL_ID=channel-1}}
    ```
...
>```shell
>{{#template ../../templates/commands/hermes/query/packet/pending.md CHAIN_ID=ibc-1 PORT_ID=transfer CHANNEL_ID=channel-1}}
>```
...
```shell
{{#template ../../templates/commands/hermes/start.md OPTIONS=--config $HOME/hermes_second_instance.toml}}
```
...
- Stop Hermes by pressing `Ctrl+C` on the terminals running `{{#template ../../templates/commands/hermes/start.md}}`.
