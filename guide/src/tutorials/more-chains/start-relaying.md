...
- Balances on `ibc-0`:
    ...
    ```shell
    {{#template ../../templates/commands/gaia/query_balances.md node=tcp://localhost:27050 home=~/.gm/ibc-0 wallet=wallet}}
    ```

- Balances on `ibc-1`:

    ```shell
    {{#template ../../templates/commands/gaia/query_balances.md node=tcp://localhost:27060 home=~/.gm/ibc-1 wallet=wallet}}
    ```

- Balances on `ibc-2`:

    ```shell
    {{#template ../../templates/commands/gaia/query_balances.md node=tcp://localhost:27070 home=~/.gm/ibc-2 wallet=wallet}}
    ```

- Balances on `ibc-3`:

    ```shell
    {{#template ../../templates/commands/gaia/query_balances.md node=tcp://localhost:27080 home=~/.gm/ibc-3 wallet=wallet}}
    ```
