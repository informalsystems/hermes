...
- MacOS: `hermes-v0.3.1-x86_64-apple-darwin.tar.gz` (or .zip),
- Linux: `hermes-v0.3.1-x86_64-unknown-linux-gnu.tar.gz` (or .zip).
...
Then checkout the release, for example if the most recent release is `v0.3.1` then execute the command:
