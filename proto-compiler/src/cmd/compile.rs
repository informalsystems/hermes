...
impl CompileCmd {
	...
	fn compile_ibc_protos(ibc_dir: &Path, out_dir: &Path) {
		...
		let compilation = tonic_build::configure()
			...
			.field_attribute(".ibc.core.commitment.v1.MerkleRoot.hash", attrs_serde_base64)
			.field_attribute(".ibc.core.commitment.v1.MerkleRoot.hash", attrs_jsonschema_str)
			.type_attribute(".ibc.core.commitment.v1.MerklePrefix", attrs_jsonschema)
			.field_attribute(".ibc.core.commitment.v1.MerklePrefix.key_prefix", attrs_serde_base64)
			.field_attribute(
