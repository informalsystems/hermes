...
similarly the commit hash for IBC-go is saved into `$out/IBC_GO_COMMIT`.

The two commit values are exposed via the `ibc_proto::COSMOS_SDK_COMMIT` and `ibc_proto::IBC_GO_COMMIT`
